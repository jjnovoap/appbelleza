...
public class SubcategoryProductAdapter$MyViewHolder_ViewBinding implements Unbinder {
  private SubcategoryProductAdapter.MyViewHolder target;

  @UiThread
  public SubcategoryProductAdapter$MyViewHolder_ViewBinding(
      SubcategoryProductAdapter.MyViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SubcategoryProductAdapter.MyViewHolder target = this.target;
